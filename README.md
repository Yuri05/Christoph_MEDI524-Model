# MEDI-524-Model
Whole-body PBPK model of the antibody MEDI-524 in monkeys [1]. 
...
**The latest release of the snapshot of the model, the evaluation plan and the static content can be found [here](https://github.com/Open-Systems-Pharmacology/MEDI524-Model/releases/latest).**
